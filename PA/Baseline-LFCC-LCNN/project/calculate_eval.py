...
def find_metrics(scores_file_path, protocols_file_path):
    ...
    minDCF, eer, cllr, actDCF = calculate_minDCF_EER_CLLR_actDCF(cm_scores, cm_keys)
    
    return minDCF, eer, cllr, actDCF

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    # set scores file path and protocols file path
    parser.add_argument('--scores', type=str, default='/home/sarah.azka/speech/LFCC/PA/Baseline-LFCC-LCNN/project/baseline_PA/log_eval_for_cv_only_to_prosa_score.txt')
    parser.add_argument('--protocols', type=str, default='/home/sarah.azka/speech/DATA_TA_PA/protocol.txt')
    ...
    # Example usage (replace with the actual paths to your files)
    minDCF, eer, cllr, actDCF = find_metrics(scores_file_path, protocols_file_path)
