...
log_name=log_eval_prosa_only_to_cv
# trained_model=__pretrained/trained_network.pt 
trained_model=/home/sarah.azka/speech/LFCC/PA/Baseline-LFCC-LCNN/PA_FOLD_2_SCORES.pt

echo -e "Run evaluation"
source $PWD/../../env.sh
CUDA_VISIBLE_DEVICES=2 python main.py --inference --model-forward-with-file-name \
